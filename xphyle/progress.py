...
from xphyle.types import Iterable, Union, Callable, Tuple, Sequence, FileLike
    ...
    def update(self, enable: bool = None,
        ...
        if wrapper:
            ...
            try:
                ...
                raise ValueError("Could not create default python wrapper; "
                                 "valid wrapper must be specified") from err
    
    def wrap(self, itr: Iterable, desc: str = None,
...
def system_progress_command(exe: str, *args, require: bool = False) -> Tuple: # pragma: no-cover
    ...
    def update(self, enable: bool = None,
        ...
        if wrapper:
            ...
            try:
                ...
                raise ValueError("Could not create default system wrapper; "
                                 "valid wrapper must be specified") from err
    
    def wrap(self, cmd: Sequence[str], stdin: FileLike, stdout: FileLike,
...
def iter_file_chunked(fileobj: FileLike, chunksize: int = 1024):
